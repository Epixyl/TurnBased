...
while(ds_priority_empty(queueid) == false){
    ...
    if(ds_map_exists(mapid, unwrap) == false){
        ...
        if groundid > 0 ds_list_add(location,groundid.id);
        ...
        for(i = 0; i < 4; i++;){
            ...
            switch(groundid.type){
                case 0: 
                    movecost = 6;
                    if u.water = 1 movecost = 999; 
                break;
                case 1: 
                    movecost = 999;
                    if u.living = 1 movecost = 12;
                    if u.water = 1 movecost = 6;
                break;
                case 2: movecost = 4; 
                    if u.type = 5 movecost = 6;
                break;
                case 3: 
                    movecost = 12;
                    if u.living = 0 movecost = 999;
                    if u.type = 5 movecost = 6;
                break;
                case 4: 
                    movecost = 999; 
            ...
            if(tileid > 0){
            if (obj_control.turn*tileid.side == -1)
                movecost = 999;
            }
